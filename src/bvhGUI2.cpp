...
#include "../dependencies/MocapNET/src/MocapNET2/MocapNETLib2/visualization/opengl.hpp"
#include "../dependencies/MocapNET/src/MocapNET2/MocapNETLib2/visualization/drawSkeleton.hpp"
#include <vector>
...
#include "../dependencies/MocapNET/dependencies/RGBDAcquisition/opengl_acquisition_shared_library/opengl_depth_and_color_renderer/src/Library/MotionCaptureLoader/edit/bvh_rename.h"
    ...
    while(!state.stop)
        {
            ...
            imshow("BVH", viewMat);
                      ...
                      if  ( 
                            (MOCAPNET_OUTPUT_NUMBER==state.bvhConfiguration.size())  
                          ...
                          {  
                            ...
                            for (unsigned int i=0; i<MOCAPNET_OUTPUT_NUMBER; i++)
                             {
                                 bvhFrame.data[i] = state.bvhConfiguration[i];
                             }
